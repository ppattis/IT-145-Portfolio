	...
	// to make sure the monkey doesn't already exist and the species type is allowed
        ...
        public static void reserveAnimal(Scanner scanner) {
            ...
            do
            {
            	...
            	if (!animalType.toLowerCase().equals("Dog") || !animalType.toLowerCase().equals("Monkey"))
            	{
            		System.out.println("Invalid input.  Valid input is either Dog or Monkey.");
            	}
            } while (!animalType.toLowerCase().equals("Dog") || !animalType.toLowerCase().equals("Monkey"));
            
            do
            {
            	System.out.println("Enter the country to reserve an animal in:");
            ...
            if (animalType.equals("Dog"))
            {
            	...
            	reserved.setInServiceCountry(country);
            	System.out.println("We have reserved " + reserved.getName() + " a " + reserved.getGender() + " " + reserved.getBreed());
            }
            else
            {
            	Monkey reserved = null;
            	for (Monkey monkey : monkeyList)
            	{
            	...
            	reserved.setReserved(true);
            	reserved.setInServiceCountry(country);
            	System.out.println("We have reserved " + reserved.getName() + " a " + reserved.getGender() + " " + reserved.getSpecies());
            }
        }
        ...
        public static void printAnimals(String reportType) {
        	String output;
            if (reportType.equals("dogs"))
            {
            	output = String.format("%45s %8s %45s", "", "All Dogs", "");
            	System.out.println(output);
            	output = String.format("%-20s%1s%-20s%1s%-20s%1s%-20s%1s%-20s", "Name", "|", "Breed", "|", "Status", "|", "Acquisition Country", "|", "Status");
            	System.out.println(output);
            	System.out.println("--------------------|--------------------|--------------------|--------------------|--------------------");
            	for (Dog dog : dogList)
            	{
            		...
            		if (dog.getReserved())
            			status = "Reserved";
            		output = String.format("%-20s%1s%-20s%1s%-20s%1s%-20s%1s%-20s", dog.getName(), "|", dog.getBreed(), "|", dog.getTrainingStatus(), "|", dog.getAcquisitionLocation(), "|", status);
            		System.out.println(output);
            	}
            }
            else if (reportType.equals("monkeys"))
            {
            	output = String.format("%43s %12s %43s", "", "All Monkeys", "");
            	System.out.println(output);
            	output = String.format("%-20s%1s%-20s%1s%-20s%1s%-20s%1s%-20s", "Name", "|", "Species", "|", "Status", "|", "Acquisition Country", "|", "Status");
            	System.out.println(output);
            	System.out.println("--------------------|--------------------|--------------------|--------------------|--------------------");
            	for (Monkey monkey : monkeyList)
            	{
            		...
            		if (monkey.getReserved())
            			status = "Reserved";
            		output = String.format("%-20s%1s%-20s%1s%-20s%1s%-20s%1s%-20s", monkey.getName(), "|", monkey.getSpecies(), "|", monkey.getTrainingStatus(), "|", monkey.getAcquisitionLocation(), "|", status);
            		System.out.println(output);
            	}
            }
            else if (reportType.equals("available"))
            {
            	output = String.format("%34s %13s %34s", "", "All Available", "");
            	System.out.println(output);
            	output = String.format("%-20s%1s%-20s%1s%-20s%1s%-20s", "Animal Type", "|", "Name", "|", "Breed/Species", "|", "Acquisition Country");
            	System.out.println(output);
            	System.out.println("--------------------|--------------------|--------------------|--------------------");
            	for (Dog dog : dogList)
            	{
            		...
            		{
            			output = String.format("%-20s%1s%-20s%1s%-20s%1s%-20s", "Dog", "|", dog.getName(), "|", dog.getBreed(), "|", dog.getAcquisitionLocation());
            			System.out.println(output);
            		}
            	}
            	for (Monkey monkey : monkeyList)
            	{
            		...
            		{
            			output = String.format("%-20s%1s%-20s%1s%-20s%1s%-20s", "Monkey", "|", monkey.getName(), "|", monkey.getSpecies(), "|", monkey.getAcquisitionLocation());
            			System.out.println(output);
            		}
            	}
            }
